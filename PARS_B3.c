...
sT[0].sTI[11].nType = TYP_TMOK;	
	...
	sT[0].sMOT[11].nIEC_NM			= 1028;		/* Mérések IEC kezdõcíme */		
	sT[0].sMOT[11].nNMNum      	= 4;
...
sT[0].sTI[24].nType = TYP_TMOK;	
	...
	sT[0].sMOT[24].nIEC_NM			= 1024;		/* Mérések IEC kezdõcíme */		
...
sT[0].sTI[122].nType = TYP_TMOK;	
	...
	sT[0].sMOT[122].nIEC_NM			= 1032;		/* Mérések IEC kezdõcíme */		
	sT[0].sMOT[122].nNMNum      = 4;
...
sT[0].sTI[149].nType = TYP_TMOK;	
	...
	sT[0].sMOT[149].nIEC_NM			= 920;		/* Mérések IEC kezdõcíme */		
...
sT[0].sTI[187].nType = TYP_TMOK;	
	...
	sT[0].sMOT[187].nIEC_NM			= 1036;		/* Mérések IEC kezdõcíme */		
...
sT[0].sTI[209].nType = TYP_TMOK;	
	...
	sT[0].sMOT[209].nIEC_NM			= 916;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[209].nNMNum			= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[211].nType = TYP_TMOK;	
	...
	sT[0].sMOT[211].nIEC_NM			= 924;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[211].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[212].nType = TYP_TMOK;	
	...
	sT[0].sMOT[212].nIEC_NM			= 928;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[212].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[213].nType = TYP_TMOK;	
	...
	sT[0].sMOT[213].nIEC_NM			= 932;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[213].nNMNum				= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[215].nType = TYP_TMOK;	
	...
	sT[0].sMOT[215].nIEC_NM			= 936;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[215].nNMNum			= 4;		/* Analóg mérések száma*/
...
sT[0].sTI[216].nType = TYP_TMOK;	
	...
	sT[0].sMOT[216].nIEC_NM			= 944;		/* Mérések IEC kezdõcíme */	
...
sT[0].sTI[233].nType = TYP_TMOK;	
	...
	sT[0].sMOT[233].nIEC_NM			= 1040;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[233].nNMNum      	= 4;
...
sT[0].sTI[238].nType = TYP_TMOK;	
	...
	sT[0].sMOT[238].nIEC_NM			= 972;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[238].nNMNum      	= 4;
...
sT[0].sTI[241].nType = TYP_TMOK;	
	...
	sT[0].sMOT[241].nIEC_NM			= 992;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[241].nNMNum      	= 4;
...
sT[0].sTI[246].nType = TYP_TMOK;	
	...
	sT[0].sMOT[246].nIEC_NM			= 956;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[246].nNMNum      	= 4;
...
sT[0].sTI[247].nType = TYP_TMOK;	
	...
	sT[0].sMOT[247].nIEC_NM			= 988;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[247].nNMNum      	= 4;
...
sT[0].sTI[254].nType = TYP_TMOK;	
	...
	sT[0].sMOT[254].nIEC_NM			= 980;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[254].nNMNum      	= 4;
...
sT[0].sTI[255].nType = TYP_TMOK;	
	...
	sT[0].sMOT[255].nIEC_NM			= 1000;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[255].nNMNum      	= 4;
...
sT[0].sTI[257].nType = TYP_TMOK;	
	...
	sT[0].sMOT[257].nIEC_NM			= 1008;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[257].nNMNum      = 4;
...
sT[0].sTI[263].nType = TYP_TMOK;	
	...
	sT[0].sMOT[263].nIEC_NM			= 984;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[263].nNMNum      	= 4;
...
sT[0].sTI[265].nType = TYP_TMOK;	
	...
	sT[0].sMOT[265].nIEC_NM			= 952;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[265].nNMNum      	= 4;
...
sT[0].sTI[267].nType = TYP_TMOK;	
	...
	sT[0].sMOT[267].nIEC_NM			= 968;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[267].nNMNum      	= 4;
...
sT[0].sTI[269].nType = TYP_TMOK;	
	...
	sT[0].sMOT[269].nIEC_NM			= 976;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[269].nNMNum      	= 4;
...
/* Front end D -----------------------------------------------------------*/
sT[0].sTI[274].nType = TYP_FRONTEND;

/* Front end F -----------------------------------------------------------*/
sT[0].sTI[275].nType = TYP_FRONTEND;

/* Front end H -----------------------------------------------------------*/
sT[0].sTI[276].nType = TYP_FRONTEND;

/* B redundancia -----------------------------------------------------------*/
sT[0].sTI[277].nType = TYP_FRONTEND;
